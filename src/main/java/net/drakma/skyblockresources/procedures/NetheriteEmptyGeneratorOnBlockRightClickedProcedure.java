...
public class NetheriteEmptyGeneratorOnBlockRightClickedProcedure {
				...
				if (world instanceof Level _lvl) {
					...
					for (SetGeneratorGUIRecipe recipe : recipes) {
						...
						if (!ingredients.get(0).test((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)))
							continue;
						if (!ingredients.get(1).test(new ItemStack(SkyblockResourcesModBlocks.NETHERITE_EMPTY_GENERATOR.get())))
							continue;
