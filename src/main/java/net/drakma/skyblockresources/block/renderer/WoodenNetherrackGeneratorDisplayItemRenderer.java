...
public class WoodenNetherrackGeneratorDisplayItemRenderer extends GeoItemRenderer<WoodenNetherrackGeneratorDisplayItem> {
	...
	@Override
	public RenderType getRenderType(WoodenNetherrackGeneratorDisplayItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
