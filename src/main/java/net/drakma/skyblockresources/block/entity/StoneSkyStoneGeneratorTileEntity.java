...
public class StoneSkyStoneGeneratorTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public StoneSkyStoneGeneratorTileEntity(BlockPos pos, BlockState state) {
		super(SkyblockResourcesModBlockEntities.STONE_SKY_STONE_GENERATOR.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(StoneSkyStoneGeneratorBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<StoneSkyStoneGeneratorTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<StoneSkyStoneGeneratorTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("stone_sky_stone_generator");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Stone Sky Stone Generator");
	}
