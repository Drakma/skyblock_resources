...
public class DiamondDioriteGeneratorTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public DiamondDioriteGeneratorTileEntity(BlockPos pos, BlockState state) {
		super(SkyblockResourcesModBlockEntities.DIAMOND_DIORITE_GENERATOR.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(DiamondDioriteGeneratorBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<DiamondDioriteGeneratorTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<DiamondDioriteGeneratorTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("diamond_diorite_generator");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Diamond Diorite Generator");
	}
