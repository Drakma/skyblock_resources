...
public class NetheriteGraniteGeneratorTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public NetheriteGraniteGeneratorTileEntity(BlockPos pos, BlockState state) {
		super(SkyblockResourcesModBlockEntities.NETHERITE_GRANITE_GENERATOR.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(NetheriteGraniteGeneratorBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<NetheriteGraniteGeneratorTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<NetheriteGraniteGeneratorTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("netherite_granite_generator");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Netherite Granite Generator");
	}
