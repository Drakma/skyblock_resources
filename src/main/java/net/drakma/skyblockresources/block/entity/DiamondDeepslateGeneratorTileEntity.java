...
public class DiamondDeepslateGeneratorTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public DiamondDeepslateGeneratorTileEntity(BlockPos pos, BlockState state) {
		super(SkyblockResourcesModBlockEntities.DIAMOND_DEEPSLATE_GENERATOR.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(DiamondDeepslateGeneratorBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<DiamondDeepslateGeneratorTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<DiamondDeepslateGeneratorTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("diamond_deepslate_generator");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Diamond Deepslate Generator");
	}
